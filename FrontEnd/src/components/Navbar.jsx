...
function Navbar() {
  ...
  return (
    <>
     <div className={`max-w-screen-2xl dark:bg-slate-900 dark:text-white  container mx-auto md:px-20 px-4 fixed top-0 right-0 left-0 z-50 ${sticky ? " sticky-navbar shadow-md bg-base-200 transition-all ease-in-out" : ""}`
      }>
  ...
  <div className="">
    <a className="btn bg-black text-white px-5 hover:bg-zinc-900"onClick={()=>document.getElementById("my_modal_5").showModal()}>Login</a><Login/>
  </div>
  </div>
</div>
    </div>
